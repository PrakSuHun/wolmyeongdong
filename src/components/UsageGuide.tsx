...
const rules: { icon: LucideIcon; title: string; desc: string }[] = [
  ...
  },
  {
    ...
    desc: "음식물 섭취는 지정된 장소(청산관 카페, 성자 사랑의집 식당)에서만 가능하며, 경내 취사 및 야영 행위는 절대 금합니다.",
  },
  {
    icon: CigaretteOff,
    title: "전 구역 금연·금주 지역",
    desc: "음주, 흡연, 고성방가, 애정행각 등 수련 활동에 방해가 되는 일체의 행위를 금합니다.",
  },
  {
    icon: Trash2,
    title: "쓰레기 되가져가기 및 자율 정리",
    desc: "'쓰레기 되가져가기 운동'에 동참하여 깨끗한 수련원 만들기에 협조해 주시기 바랍니다.",
  },
  {
    icon: CameraOff,
    title: "무단 촬영 금지",
    desc: "네이처 스테이 경내는 촬영이 금지되어 있습니다. 무단으로 촬영 시 퇴장 조치될 수 있습니다.",
  },
  {
    icon: Sprout,
